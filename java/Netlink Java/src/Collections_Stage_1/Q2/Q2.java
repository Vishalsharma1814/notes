...
import Java8.MethodReference.Interf3;
...
//        }
//
//       Integer s = students.stream().map((o1, Integer) -> o1.getMarks() ) >=  )
...
//        }
        ...
        Student ss = students.stream().min((o1, o2) -> (int) (o1.getMarks()- o2.getMarks())).get();
